    ...
    <section className="max-w-[1440px] mx-auto px-8 md:px-16 py-12 md:py-0 md:h-[calc(100vh-72px)] flex items-center">
      <FocusBox className="grid grid-cols-1 md:grid-cols-12 gap-16 items-center w-full">
        ...
        <div className="md:col-span-5 flex flex-col gap-6">
          <img 
            src="https://lh3.googleusercontent.com/aida/ADBb0ugbe_m3Xp7FfQG_Id58at-UhcH5FNFuazzXTMizuloMGNXJK2KVyOqVATQotj5ytRbcD_ZB1ZziVia2U0_pdgMowxikNTinAZj_BER-z3CdaFWXRuHivZkPvGS0JmR5HvkuSFrnV8N4tNDfAZV1VYN0zA1Azadyqo2O1JUDoJeghUSk4Qh2Z_oQdC8lK9hxKB3u14BMujK5PQTrarkld5k-XTS_c1Fsj1-5taNwH4CXrwAmb1WnJhslQ4UkjZ1Y7KHBqHOnPbruFw" 
          ...
          <div className="p-8 bg-surface-container-low rounded-xl border border-primary/5">
            ...
            <h3 className="text-xl font-serif mb-3">Tactile Warmth</h3>
            <p className="text-sm text-on-surface-variant leading-relaxed">
              Experience shadows as structural elements. Our design uses light-play to define depth, creating a physical sense of tranquility that evolves throughout the day.
            </p>
          </div>
        </div>
      </FocusBox>
