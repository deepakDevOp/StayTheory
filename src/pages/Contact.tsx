...
const WA_NUMBER = "917827467208";
const WA_MESSAGE = encodeURIComponent(
  "Hi Ritu, I want to enquire about your properties on Stay Theory."
);
...
export default function Contact() {
  // Lock body scroll on mobile so the page truly doesn't scroll
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  return (
    <>
      ...
      {/* Mobile: locked to viewport. Desktop: normal scroll */}
      <main className="fixed md:relative inset-0 md:inset-auto flex flex-col pt-[72px] md:pt-0 md:min-h-screen overflow-hidden md:overflow-visible">
        ...
        {/* Inner scrollable area (desktop only) */}
        <div className="flex-1 min-h-0 overflow-hidden md:overflow-visible flex flex-col">
          <div className="flex-1 min-h-0 flex flex-col px-5 md:px-8 lg:px-16 pt-6 pb-4 md:py-20 max-w-2xl mx-auto w-full overflow-hidden">
            ...
            <motion.div
              ...
              className="mt-3 px-4 py-3 rounded-2xl bg-stone-50 border border-stone-100 flex items-center justify-between gap-3 shrink-0"
            >
